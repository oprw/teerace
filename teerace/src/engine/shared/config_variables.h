...
// mkRace
MACRO_CONFIG_INT(SvUndoKill, sv_undo_kill, 0, 0, 99999, CFGFLAG_SERVER, "Number of undo kill")
...
MACRO_CONFIG_INT(SvHit, sv_hit, 1, 0, 1, CFGFLAG_SERVER, "Whether players can hammer/grenade/laser each other or not")
